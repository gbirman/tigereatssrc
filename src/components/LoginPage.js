            ...
            <div>
                ...
                >
                    ...
                    <Grid item xs={3} >
                        ...
                        <Button className={classes.loginButton} variant="contained" color="primary" onClick={() => axios.get('http://127.0.0.1:5000/cas').catch((error) => {console.error(error);})}>Login with CAS</Button>
                    </Grid>
                </Grid>
            </div>
        )
