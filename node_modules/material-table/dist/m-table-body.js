...
export default class MTableBody extends React.Component {
  render() {
    ...
    return React.createElement(TableBody, null, this.props.options.filtering && React.createElement(MTableFilterRow, {
      ...
      return React.createElement(MTableBodyRow, {
        data: data,
        index: index,
        key: index,
    ...
    }), [...Array(emptyRowCount)].map((r, index) => React.createElement(TableRow, {
      style: {
        height: 49
      },
      key: 'empty-' + index
